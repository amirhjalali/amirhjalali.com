...
1. **Real-time topical feed**  
   ...
   - Status: ✅ “Today’s Signals” panel renders headline queue data; automation of ingestion still pending.
...
3. **Visual layout refresh**  
   ...
   - Status: ✅ Featured hero treatment and refreshed grid shipped; automated image pipeline remains a follow-up.

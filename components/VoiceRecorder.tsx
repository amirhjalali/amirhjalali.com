    ...
    return (
      <div className="glass p-8 rounded-2xl border border-white/10 text-center">
        ...
        <button
          ...
          className="px-6 py-3 bg-white text-black font-mono text-xs uppercase tracking-widest rounded-full hover:bg-[#EAEAEA] hover:scale-105 transition-all"
        >
          Grant Permission
        </button>
      </div>
    ...
    <div className="glass p-8 rounded-2xl border border-white/10">
      <div className="text-center">
        ...
        <div className="mb-8">
          ...
          {/* Timer */}
          {isRecording && (
            <div className="text-[#EAEAEA] text-xl font-mono mb-4">
        ...
        <div className="flex justify-center gap-4 mb-6">
          {!isRecording ? (
            <motion.button
              ...
              className="w-16 h-16 bg-white rounded-full flex items-center justify-center text-black hover:bg-[#EAEAEA] hover:shadow-lg hover:shadow-white/10 transition-all disabled:opacity-50"
            >
            ...
            <motion.button
              ...
              className="w-16 h-16 bg-white/20 border-2 border-white rounded-full flex items-center justify-center text-white hover:bg-white/30 transition-all"
            >
              <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          {audioBlob && (
            <motion.button
              ...
              className="w-16 h-16 glass border border-white/20 rounded-full flex items-center justify-center hover:border-white/40 transition-all"
            >
        ...
        <AnimatePresence>
          {audioBlob && (
            <motion.div
              ...
              exit={{ opacity: 0, y: -10 }}
              className="bg-white/5 border border-white/20 rounded-lg p-4 mb-4"
            >
              <div className="flex items-center justify-center gap-2 text-[#EAEAEA]">

  ...
  return (
    <div className="min-h-screen relative bg-[#050505] text-[#EAEAEA]">
      ...
      <div className="relative z-10 section-padding container-padding max-w-7xl mx-auto">
        ...
        >
          <h1 className="text-page-title mb-6">About</h1>
                ...
                >
                  ...
                  <div className="glass p-5 md:p-8 rounded-xl border border-white/10 hover:bg-white/5 transition-all backdrop-blur-md group">
                    <div className="flex flex-col md:flex-row md:justify-between md:items-start gap-2 mb-4">
                      <h2 className="text-lg md:text-xl font-serif font-light text-[#EAEAEA] group-hover:text-white transition-colors">{exp.title}</h2>
